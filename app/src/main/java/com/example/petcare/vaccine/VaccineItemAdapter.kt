...
class VaccineItemAdapter(var results: ArrayList<VaccineLocation>) : RecyclerView.Adapter<VaccineItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: VaccineItemAdapter.ViewHolder, position: Int) {
    ...
    interface OnClickListener {
        fun onClick(position: Int, item: VaccineLocation)
    }
    ...
    fun setFilteredList(filteredList : ArrayList<VaccineLocation>){
        results = filteredList
        notifyDataSetChanged()
    }
    @SuppressLint("NotifyDataSetChanged")
    fun setRVmWithDistance(newGroomingList : ArrayList<VaccineLocation>){
